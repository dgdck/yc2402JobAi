...
def hello_world(jobrole):
    ...
    response = client.chat.completions.create(
        ...
        messages=[{
            "role": "system",
            "content": f"what are the major skills of: {jobrole}, " +
            "and which five questions for a job interview should I prepare for, " +
            "give me back in HTML format, use header 2 for titles."
        }],
        temperature=0.5,
        max_tokens=3000
    )
